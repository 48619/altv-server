...
class kt {
  ...
  static GetTextWidth(e, t, _) {
    y.beginTextCommandGetWidth("CELL_EMAIL_BCON"), bt.AddLongString(e), y.setTextFont(t), y.setTextScale(1, _);
  ...
  set Visible(e) {
    if (((this._visible = e), Ft.PlaySound(this.AUDIO_BACK, this.AUDIO_LIBRARY), this.UpdateScaleform(), e && this.UpdateDescriptionCaption(), !0 !== this._justOpenedFromPool))
      if (e) {
        ...
        null === this.ParentMenu && Yt.includes(this) && Yt.length && (Yt[Yt.length - 1] === this && (Yt.pop(), (this._justOpenedFromPool = !0), Yt.length || (this._poolOpening = null)), Yt.length && ((this._poolOpening = Yt[Yt.length - 1]), (Yt[Yt.length - 1].Visible = !0))), 0 === Yt.length && y.setMouseCursorSprite(1);
      }
    ...
    super(e, t),
      ...
      this.addItem(
        (this.torqueMultiplierItem = new zt(
          ...
          (e, t, _) => (_ == yt.Right ? (this.multiplier = +t + 5) : (this.multiplier = +t - 5), "" + this.multiplier.toFixed(2)),
          void 0,
